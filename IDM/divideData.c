...
//Structure for storing first two max looping variable values
struct ip_var
{
    char* name;
    double value;
                    ...
                    for(pi[3] = input[4].values[0]; pi[3] <= input[4].values[1]; pi[3] += input[4].values[2])
                    {
                        for(pi[4] = input[5].values[0]; pi[4] <= input[5].values[1]; pi[4] += input[5].values[2])
                        {
                            for(pi[5] = input[6].values[0]; pi[5] <= input[6].values[1]; pi[5] += input[6].values[2])
                            {
                                ...
                                fprintf(outfiles,"%lf,%lf,%lf,%lf,%lf,%lf,%lf,",ip_file[pf][0].value,ip_file[pf][1].value,pi[1],pi[2],pi[3],pi[4],pi[5]);
                                fclose(outfiles);
