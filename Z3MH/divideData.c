                            				...
                            				for(pi[9] = input[10].values[0]; pi[9] <= input[10].values[1]; pi[9] += input[10].values[2])
                            				{
                            					for(pi[10] = input[11].values[0]; pi[10] <= input[11].values[1]; pi[10] += input[11].values[2])
                            					{
                            						for(pi[11] = input[12].values[0]; pi[11] <= input[12].values[1]; pi[11] += input[12].values[2])
                            						{
													    ...
													    fprintf(outfiles,"%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf",ip_file[pf][0].value,ip_file[pf][1].value,pi[1],pi[2],pi[3],pi[4],pi[5],pi[6],pi[7],pi[8],pi[9],pi[10],pi[11]);
														fclose(outfiles);
...
*****************************************************************************************************/
    ...
    fprintf(output,"%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,ERROR\n",input[0].name,input[1].name,input[2].name,input[3].name,input[4].name,input[5].name,input[6].name,input[7].name,input[8].name,input[9].name,input[10].name,input[11].name,input[12].name);
